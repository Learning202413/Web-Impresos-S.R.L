...
export class PedidosService {
    ...
    // Buscar el último archivo enviado por el DISEÑADOR para aprobar
    ...
    // MODIFICADO: Subir el arte inicial del cliente (SIN CAMBIAR ESTADO)
    async subirArteCliente(ordenId, file) {
        try {
            ...
            // --- SECCIÓN ELIMINADA: Ya no se actualiza el estado a 'En Pre-prensa' ---
            // El estado se mantendrá como estaba (ej. 'Nueva')
